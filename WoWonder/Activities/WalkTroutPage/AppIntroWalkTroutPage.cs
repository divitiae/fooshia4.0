    ...
    public class AppIntroWalkTroutPage : AppIntro2
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                switch (AppSettings.WalkThroughSetFlowAnimation)
                {
                    case true:
                        SetFlowAnimation();
                        break;
                    default:
                    {
                        switch (AppSettings.WalkThroughSetZoomAnimation)
                        {
                            case true:
                                SetZoomAnimation();
                                break;
                            default:
                            {
                                switch (AppSettings.WalkThroughSetSlideOverAnimation)
                                {
                                    case true:
                                    ...
                                    default:
                                    {
                                        switch (AppSettings.WalkThroughSetDepthAnimation)
                                        {
                                            case true:
                                                SetDepthAnimation();
                                                break;
                                            default:
                                            {
                                                switch (AppSettings.WalkThroughSetFadeAnimation)
                                                {
                                                    case true:
                                                        SetFadeAnimation();
                                                        break;
