...
using WoWonder.Activities.NearbyShops.Adapters;
...
namespace WoWonder.Activities.NearbyShops
{
    [Activity(Icon = "@mipmap/icon", Theme = "@style/MyTheme", ConfigurationChanges = ConfigChanges.Locale | ConfigChanges.UiMode | ConfigChanges.ScreenSize | ConfigChanges.Orientation | ConfigChanges.ScreenLayout | ConfigChanges.SmallestScreenSize)]
    public class NearbyShopsActivity : BaseActivity
    {
        #region Variables Basic

        public NearbyShopsAdapter MAdapter;
        ...
        private Xamarin.Facebook.Ads.RewardedVideoAd RewardedVideo;
        ...
        private void SearchView_OnTextSubmit(object sender, SearchView.QueryTextSubmitEventArgs e)
        {
            try
            {
                ...
                MAdapter.NearbyShopsList.Clear();
        ...
        private void InitToolbar()
        {
            try
            {
                ...
                if (ToolBar != null)
                {
                    ToolBar.Title = GetText(Resource.String.Lbl_NearbyShops);
        ...
        private void MAdapterOnItemClick(object sender, NearbyShopsAdapterClickEventArgs e)
        {
            try
            {
                ...
                if (item != null)
                {
                    ...
                    intent.PutExtra("Id", item.Product?.ProductClass.PostId);
                    intent.PutExtra("ProductView", JsonConvert.SerializeObject(item.Product?.ProductClass));
        ...
        private void MainScrollEventOnLoadMoreEvent(object sender, EventArgs e)
        {
            try
            {
                ...
                var item = MAdapter.NearbyShopsList.LastOrDefault();
        ...
        private void BtnFilterOnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                bundle.PutString("TypeFilter", "NearbyShops");
